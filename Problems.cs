...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemSix()
        {
            ...
            var maxDate = new DateTime(2018, 1, 1);
            foreach (User user in users)
            {
                if ( user.RegistrationDate > minDate & user.RegistrationDate < maxDate)
                {
                    Console.WriteLine(user.Email + ": " + user.RegistrationDate);
                }
            }
        ...
        private void ProblemEight()
        {
            ...
            var UserProducts = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => sc.User.Email == "afton@gmail.com");
        ...
        private void ProblemTwelve()
        {
            // Create a new Product object and add that product to the Products table using LINQ.
             Product newproduct = new Product()
                {
                    Name = "Iphone 50",
                    Description = "newest top of thwe line luxurios phone of tomorrow",
                    Price = 50000
            };
        ...
        private void ProblemFourteen()
        {
            ...
            var productId = _context.Products.Where(p => p.Name == "Iphone 50").Select(p => p.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
